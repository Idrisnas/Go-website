    ...
    >
      <div className="max-w-6xl mx-auto px-4 md:px-8 flex justify-between items-center py-3 mt-6 rounded-full bg-[#FDF4D4]">
        ...
        <div className="hidden md:flex gap-4">
          ...
          <RoundedButton to="/driver" text="Become a Driver" variant="primary" />
        </div>
...
>
  ...
  <div className="flex justify-between items-center border-b-8 border-gray-700  pb-4 bg--700">
    ...
    <RoundedButton to="/partner" text="Partner" variant="outline" className="border  text-[10px] py-1 px-5" />
...
{/* Navigation Links */}
<div className="flex flex-col items-start mt-4 text-left text-base font-sora text-black w-full">
