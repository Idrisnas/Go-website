      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 my-10 space-y-8">
        ...
        {faqs.map((faq, index) => {
          ...
          return (
            <div key={index}>
              <div
                className={`bg-[#FDF4D4] px-2 py-2 md:py-6 md:px-8 flex justify-between items-center cursor-pointer transition-all duration-300 ${
              ...
              {isOpen && (
                <div className="bg-[#FBEBB0] p-3 md:p-9 rounded-b-lg">
